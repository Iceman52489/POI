...
<cfswitch expression="#THISTAG.ExecutionMode#">
	<cfcase value="Start">
		...
		<cfparam name="ATTRIBUTES.Index" type="numeric" default="#VARIABLES.ColumnsTag.ColumnIndex#" />
		<!--- Default CSS class name(s). --->
		<cfparam name="ATTRIBUTES.Class" type="string" default="" />
		<!--- Overriding CSS style values. --->
		<cfparam name="ATTRIBUTES.Style" type="string" default="" />
		<cfparam name="ATTRIBUTES.Wrap" type="boolean" default="true" />
		<!---
		...
		<cfloop index="VARIABLES.ClassName" list="#ATTRIBUTES.Class#" delimiters=" ">
			...
			<cfif StructKeyExists( VARIABLES.DocumentTag.Classes, VARIABLES.ClassName )>
				...
				<cfset VARIABLES.Style.put(VARIABLES.DocumentTag.Classes[ VARIABLES.ClassName ])>
			</cfif>
		</cfloop>

		<cfif ATTRIBUTES.Wrap>
			<cfset ATTRIBUTES.style &= ';white-space:normal;'>
		</cfif>
		...
		<cfif Len( ATTRIBUTES.Style )>
			<cfset VARIABLES.Style = VARIABLES.DocumentTag.CSSRule.AddCSS( VARIABLES.Style, ATTRIBUTES.Style ) />
		</cfif>
