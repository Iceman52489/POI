...
<cfswitch expression="#THISTAG.ExecutionMode#">
	<cfcase value="Start">
		...
		<cfset VARIABLES.DocumentTag.Classes[ ATTRIBUTES.Name ] = VARIABLES.DocumentTag.CSSRule.AddCSS( StructNew(), ATTRIBUTES.Style ) />
		<cfset VARIABLES.DocumentTag.intClasses++ />
	</cfcase>
